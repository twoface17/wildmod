...
public class ShriekParticleNX extends AbstractSlowingParticle {
    ...
    ShriekParticleNX(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, SpriteProvider spriteProvider) {
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ShriekParticleNX shriekParticle = new ShriekParticleNX(clientWorld, d, e, f, g, h, i, this.spriteProvider);
