...
public class ShriekParticlePosZ extends AbstractSlowingParticle {
    ...
    ShriekParticlePosZ(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, SpriteProvider spriteProvider) {
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ShriekParticlePosZ shriekParticle = new ShriekParticlePosZ(clientWorld, d, e, f, g, h, i, this.spriteProvider);
            shriekParticle.setColorAlpha(1.0f);
