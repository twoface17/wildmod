...
public class ShriekParticleX2 extends AbstractSlowingParticle {
    ...
    ShriekParticleX2(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, SpriteProvider spriteProvider) {
