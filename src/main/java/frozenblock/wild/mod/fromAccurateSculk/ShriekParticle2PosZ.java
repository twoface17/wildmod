...
public class ShriekParticle2PosZ extends AbstractSlowingParticle {
    ...
    ShriekParticle2PosZ(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i, SpriteProvider spriteProvider) {
    ...
    public static class Factory
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ShriekParticle2PosZ shriekParticle2 = new ShriekParticle2PosZ(clientWorld, d, e, f, g, h, i, this.spriteProvider);
