...
public class BiomeTagProvider extends AbstractTagProvider<Biome> {
    ...
    protected void configure() {
        ...
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.IS_SAVANNA).add(BiomeKeys.SAVANNA).add(BiomeKeys.SAVANNA_PLATEAU).add(BiomeKeys.WINDSWEPT_SAVANNA);
        ...
        final ObjectBuilder<Biome> objectBuilder2 = this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.IS_OVERWORLD);
        ...
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.REQUIRED_OCEAN_MONUMENT_SURROUNDING).addTag(BiomeTags.IS_OCEAN).addTag(BiomeTags.IS_RIVER);
        ...
        this.getOrCreateTagBuilder(BiomeTags.STRONGHOLD_HAS_STRUCTURE).addTag(frozenblock.wild.mod.tags.BiomeTags.IS_OVERWORLD);
        ...
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.ANCIENT_CITY_HAS_STRUCTURE).add(RegisterWorldgen.DEEP_DARK);
        ...
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.PRODUCES_CORALS_FROM_BONEMEAL).add(BiomeKeys.WARM_OCEAN);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.PLAYS_UNDERWATER_MUSIC).addTag(BiomeTags.IS_OCEAN).addTag(BiomeTags.IS_RIVER);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.HAS_CLOSER_WATER_FOG).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.WATER_ON_MAP_OUTLINES).addTag(BiomeTags.IS_OCEAN).addTag(BiomeTags.IS_RIVER).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.WITHOUT_ZOMBIE_SIEGES).add(BiomeKeys.MUSHROOM_FIELDS);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.WITHOUT_PATROL_SPAWNS).add(BiomeKeys.MUSHROOM_FIELDS);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.WITHOUT_WANDERING_TRADER_SPAWNS).add(BiomeKeys.THE_VOID);
        ...
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.SPAWNS_WARM_VARIANT_FROGS).add(BiomeKeys.DESERT).add(BiomeKeys.WARM_OCEAN).addTag(BiomeTags.IS_JUNGLE).addTag(frozenblock.wild.mod.tags.BiomeTags.IS_SAVANNA).addTag(BiomeTags.IS_NETHER).addTag(BiomeTags.IS_BADLANDS).add(RegisterWorldgen.MANGROVE_SWAMP);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.ONLY_ALLOWS_SNOW_AND_GOLD_RABBITS).add(BiomeKeys.DESERT);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.REDUCE_WATER_AMBIENT_SPAWNS).addTag(BiomeTags.IS_RIVER);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.ALLOWS_TROPICAL_FISH_SPAWNS_AT_ANY_HEIGHT).add(BiomeKeys.LUSH_CAVES);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS).add(BiomeKeys.FROZEN_OCEAN).add(BiomeKeys.DEEP_FROZEN_OCEAN);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.MORE_FREQUENT_DROWNED_SPAWNS).addTag(BiomeTags.IS_RIVER);
        this.getOrCreateTagBuilder(frozenblock.wild.mod.tags.BiomeTags.ALLOWS_SURFACE_SLIME_SPAWNS).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP);
