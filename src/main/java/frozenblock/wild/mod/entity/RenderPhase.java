...
public class RenderPhase {
    ...
    protected static final Shader ENTITY_TRANSLUCENT_EMISSIVE_SHADER = new Shader(WardenFeatureRenderer.GameRenderer::getRenderTypeEntityTranslucentEmissiveShader);
