...
public class WardenEntityModel<T extends WardenEntity> extends EntityModel<WardenEntity> {
    ...
    public void setAngles(WardenEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        float armY = -17;
            ...
            //Body transforms
            this.body.pivotY = bodyY + 60 + (AnimationAPI.easeOutSine(t * 0.68f, t * 1.04f, -40f, time) +
            ...
            //Left Leg transforms
        this.left_leg.pivotY = legY + 60 + (AnimationAPI.easeOutSine(t * 0.68f, t * 1.04f, -40f, time) +
                AnimationAPI.easeOutSine(t * 1.04f, t * 1.2f, +2f, time) +
                AnimationAPI.easeOutSine(t * 3.24f, t * 3.92f, -17f, time) +
                AnimationAPI.easeOutSine(t * 3.92f, t * 4.6f, -5f, time) +
                AnimationAPI.easeInSine(t * 4.6f, t * 4.76f, +1.13f, time) +
        ...
        this.right_leg.pivotY = legY + 60 + (AnimationAPI.easeOutSine(t * 0.68f, t * 1.04f, -40f, time) +
                AnimationAPI.easeOutSine(t * 1.04f, t * 1.2f, +2f, time) +
                AnimationAPI.easeOutSine(t * 3.24f, t * 3.92f, -17f, time) +
                AnimationAPI.easeOutSine(t * 3.92f, t * 4.6f, -5f, time) +
                AnimationAPI.easeInSine(t * 4.6f, t * 4.76f, +1.13f, time) +
            ...
            this.left_arm.pivotY = armY + (AnimationAPI.easeOutSine(t * 0.2f, t * 0.36f, -7f, time) +
            ...
            this.left_arm.pitch = (AnimationAPI.easeOutSine(t * 0.08f, t * 0.52f, -185f / j, time) +
            ...
            this.left_arm.yaw = (AnimationAPI.easeOutSine(t * 0.08f, t * 0.52f, +2f / j, time) +
            ...
            this.left_arm.roll = (AnimationAPI.easeOutSine(t * 0.08f, t * 0.52f, +22.5f / j, time) +
