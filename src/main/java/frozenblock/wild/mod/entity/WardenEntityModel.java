...
public class WardenEntityModel<T extends WardenEntity>
    ...
    public void setAngles(T wardenEntity, float f, float g, float h, float i, float j) {
        ...
        this.leftTendril.pitch = t = ((WardenEntity)wardenEntity).method_42223(k) * (float)(Math.cos((double)h * 2.25) * Math.PI * (double)0.1f);
        this.rightTendril.pitch = -t;
        long u = Util.getMeasuringTimeMs();
        //this.method_42579(((WardenEntity)wardenEntity).field_38137, Animations.field_38306, u);
        this.method_42579(((WardenEntity)wardenEntity).diggingAnimation, WardenAnimation.WARDEN_DIG, u);
        this.method_42579(((WardenEntity)wardenEntity).emergingAnimation, WardenAnimation.WARDEN_EMERGE, u);
        this.method_42579(((WardenEntity)wardenEntity).roaringAnimation, WardenAnimation.WARDEN_ROAR, u);
        this.method_42579(((WardenEntity)wardenEntity).sniffingAnimation, WardenAnimation.WARDEN_SNIFF, u);
    }
