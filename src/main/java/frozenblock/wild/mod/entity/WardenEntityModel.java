...
import frozenblock.wild.mod.mixins.ModelPartMixin;
...
public class WardenEntityModel<T extends WardenEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData modelPartData3 = modelPartData2.addChild("body", ModelPartBuilder.create().uv(0,0).cuboid(-9.0F, -9.0F, -4.0F, 18.0F, 21.0F, 11.0F), ModelTransform.pivot(0.0F, -21.0F, 0.0F));
        modelPartData3.addChild("right_ribcage", ModelPartBuilder.create().uv(90, 11).cuboid(-9.0F, -9.0F, -4.1F, 13.0F, 21.0F, 0.0F), ModelTransform.pivot(-7.0F, -2.0F, -4.0F));
        modelPartData3.addChild("left_ribcage", ModelPartBuilder.create().uv(90, 11).mirrored().cuboid(-4.0F, -9.0F, -4.1F, 13.0F, 21.0F, 0.0F).mirrored(false), ModelTransform.pivot(7.0F, -2.0F, -4.0F));
        ModelPartData modelPartData4 = modelPartData3.addChild("head", ModelPartBuilder.create().uv(0,32).cuboid(-8.0F, -24F, -5.0F, 16.0F, 16.0F, 10.0F), ModelTransform.pivot(0.0F,-13.0F,0.0F));
        modelPartData4.addChild("right_tendril", ModelPartBuilder.create().uv(52,32).cuboid(-24.0F, -28.0F, 0.0F, 16.0F, 16.0F, 0.002F), ModelTransform.pivot(-8.0F,-12.0F,0.0F));
        modelPartData4.addChild("left_tendril", ModelPartBuilder.create().uv(58,0).cuboid(8.0F, -28.0F, 0.0F, 16.0F, 16.0F, 0.002F), ModelTransform.pivot(8.0F,-12.0F,0.0F));
        modelPartData3.addChild("right_arm", ModelPartBuilder.create().uv(44,50).cuboid(-4.0F, 4.0F, -5.0F, 8.0F, 28.0F, 8.0F), ModelTransform.pivot(-13.0F,-13.0F,1.0F));
        modelPartData3.addChild("left_arm", ModelPartBuilder.create().uv(0,58).cuboid(-4.0F, 4F, -5.0F, 8.0F, 28.0F, 8.0F), ModelTransform.pivot(13.0F,-13.0F,1.0F));
        modelPartData2.addChild("right_leg", ModelPartBuilder.create().uv(76,48).cuboid(2.9F, 11.0F, -3.0F, 6.0F, 13.0F, 6.0F), ModelTransform.pivot(-5.9F,-13.0F,0.0F));
        modelPartData2.addChild("left_leg", ModelPartBuilder.create().uv(76,76).cuboid(-8.9F, 11.0F, -3.0F, 6.0F, 13.0F, 6.0F), ModelTransform.pivot(5.9F,-13.0F,0.0F));
