...
public class WardenAttackGoal <T extends LivingEntity> extends TrackTargetGoal {
    protected Class<T> targetClass;
    protected int reciprocalChance;
    protected LivingEntity targetEntity;
    protected TargetPredicate targetPredicate;

    public WardenAttackGoal(MobEntity mob, Class<T> targetClass, boolean checkVisibility) {
        this(mob, targetClass, checkVisibility, false);
    }

    public WardenAttackGoal(MobEntity mob, Class<T> targetClass, boolean checkVisibility, boolean checkCanNavigate) {
        this(mob, targetClass, 10, checkVisibility, checkCanNavigate, (Predicate)null);
    }

    public WardenAttackGoal(MobEntity mob, Class<T> targetClass, int reciprocalChance, boolean checkVisibility, boolean checkCanNavigate, @Nullable Predicate<LivingEntity> targetPredicate) {
    ...
    public WardenAttackGoal(MobEntity mob, boolean checkVisibility) {
