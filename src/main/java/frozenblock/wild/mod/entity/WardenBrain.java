...
import frozenblock.wild.mod.entity.ai.task.*;
import frozenblock.wild.mod.entity.ai.task.GoToCelebrateTask;
    ...
    private static void addFightActivities(WardenEntity warden, Brain<WardenEntity> brain) {
        brain.setTaskList(
                ...
                ImmutableList.of(
                        ...
                        new frozenblock.wild.mod.entity.ai.task.ForgetAttackTargetTask<>(
