...
public class FrogEntityModel extends EntityModel<FrogEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData1.addChild("sac", ModelPartBuilder.create().uv(8,24).cuboid(-3.5F, -3.25F, -4.5F, 7.0F, 2.0F, 3.0F, new Dilation(-0.1F)), ModelTransform.pivot(0.0F,1.0F,0.0F));
    ...
    public void setAngles(FrogEntity entity, float limbAngle, float limbDistance, float animationProgress, float netHeadYaw, float headPitch){
        ...
        this.body.pivotY = MathHelper.cos(limbAngle * 0.6662F * 2) * 1.4F * limbDistance/4 + 23;
