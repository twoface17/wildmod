...
public class RenderPhase extends net.minecraft.client.render.RenderPhase {
    ...
    protected static final Shader ENTITY_TRANSLUCENT_EMISSIVE_SHADER = new RenderPhase.Shader(frozenblock.wild.mod.render.GameRenderer::getRenderTypeEntityTranslucentEmissiveShader);
