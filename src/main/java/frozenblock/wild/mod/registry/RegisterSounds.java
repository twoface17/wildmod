...
public class RegisterSounds {
    ...
    public static final Identifier FROG_AMBIENT_ID = new Identifier(WildMod.MOD_ID, "entity.frog.ambient");
    public static SoundEvent FROG_AMBIENT_EVENT = new SoundEvent(FROG_AMBIENT_ID);
    ...
    public static void RegisterSounds() {
        ...
        Registry.register(Registry.SOUND_EVENT, FROG_AMBIENT_ID, FROG_AMBIENT_EVENT);
    }
