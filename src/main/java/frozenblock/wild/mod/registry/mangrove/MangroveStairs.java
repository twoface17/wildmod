...
public class MangroveStairs extends Block implements Waterloggable {
    ...
    public MangroveStairs(BlockState baseBlockState, Settings settings) {
        super(settings);
    ...
    static {
        ...
        TOP_SHAPE = MangroveSlab.TOP_SHAPE;
        BOTTOM_SHAPE = MangroveSlab.BOTTOM_SHAPE;
