...
public abstract class RegisterBlocks {
    ...
    public static final Block SCULK_CATALYST = new SculkCatalystBlock(SCULK_CATALYST_PROPERTIES.strength(2f, 2f).sounds(new BlockSoundGroup(1.0f, 1.0f, RegisterSounds.CATALYST_BREAK_EVENT, RegisterSounds.CATALYST_STEP_EVENT, RegisterSounds.CATALYST_PLACE_EVENT, RegisterSounds.CATALYST_STEP_EVENT, RegisterSounds.CATALYST_STEP_EVENT)));
