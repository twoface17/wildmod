...
public abstract class RegisterBlocks {
    ...
    public static final Block ROOT_CARPET = RootCarpetBlock.ROOT_CARPET;
    ...
    public static void RegisterBlocks() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(WildMod.MOD_ID, "root_carpet"), ROOT_CARPET);
        Registry.register(Registry.ITEM, new Identifier(WildMod.MOD_ID, "root_carpet"), new BlockItem(ROOT_CARPET, new FabricItemSettings().group(ItemGroup.DECORATIONS)));
