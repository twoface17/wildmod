...
public abstract class RegisterBlocks {
    ...
    public static final Block SCULK_CATALYST = new SculkCatalystBlock(SCULK_CATALYST_PROPERTIES.strength(2f, 2f).sounds(new BlockSoundGroup(0.8f, 1.0f, RegisterSounds.BLOCK_SCULK_CATALYST_BREAK, RegisterSounds.BLOCK_SCULK_CATALYST_STEP, RegisterSounds.BLOCK_SCULK_CATALYST_PLACE, RegisterSounds.BLOCK_SCULK_CATALYST_STEP, RegisterSounds.BLOCK_SCULK_CATALYST_STEP)));
