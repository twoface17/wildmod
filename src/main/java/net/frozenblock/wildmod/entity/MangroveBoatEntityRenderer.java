...
public class MangroveBoatEntityRenderer extends EntityRenderer<MangroveBoatEntity> {
    ...
    private final MangroveBoatEntityModel model;
    private final Identifier texture;


    public MangroveBoatEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.shadowRadius = 0.8F;
        this.model = new MangroveBoatEntityModel(ctx.getPart(WildModClient.MODEL_MANGROVE_BOAT_LAYER));
        this.texture = new Identifier(WildMod.MOD_ID, "textures/entity/boat/mangrove.png");
    }
    ...
    @Override
    public Identifier getTexture(MangroveBoatEntity entity) {
        return this.texture;
    }
