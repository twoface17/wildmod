...
public class ChestBoatEntityModel extends CompositeEntityModel<ChestBoatEntity> {
    ...
    public ChestBoatEntityModel(ModelPart root) {
        ...
        this.chest_top = root.getChild("chest_top");
        this.parts = ImmutableList.of(root.getChild("bottom"), root.getChild("back"), root.getChild("front"), root.getChild("right"), root.getChild("left"), this.leftPaddle, this.rightPaddle, this.chest, this.chest_top);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("chest_top", ModelPartBuilder.create().uv(0, 64).cuboid(-7.0F, 0.0F, 0.0F, 14.0F, 5.0F, 14.0F).uv(0, 64).cuboid(-1.0F, -2.0F, 14.0F, 2.0F, 4.0F, 1.0F), ModelTransform.pivot(-13.0F, -6.0F, 0.0F));
        float f = -5.0F;
    ...
    public void setAngles(ChestBoatEntity boatEntity, float f, float g, float h, float i, float j) {
        ...
        this.chest.pitch = 3.1416F;
        this.chest.yaw = -3.1416F / 2;
        this.chest_top.pitch = 3.1416F;
        this.chest_top.yaw = -3.1416F / 2;
    }
    ...
    private static void setPaddleAngle(ChestBoatEntity entity, int sigma, ModelPart part, float angle) {
