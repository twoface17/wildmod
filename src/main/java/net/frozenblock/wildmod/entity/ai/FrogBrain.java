...
public class FrogBrain {
    ...
    private static void addIdleActivities(Brain<FrogEntity> brain) {
        brain.setTaskList(
                ...
                ImmutableList.of(
                        ...
                        Pair.of(0, new BreedTask(RegisterEntities.FROG, 1.0F)),
                        Pair.of(1, new TemptTask(frog -> 1.25F)),
                        Pair.of(2, new net.frozenblock.wildmod.entity.ai.task.UpdateAttackTargetTask<>(FrogBrain::isNotBreeding, frog -> frog.getBrain().getOptionalMemory(MemoryModuleType.NEAREST_ATTACKABLE))),
                ...
                ImmutableSet.of(
                        ...
                        Pair.of(RegisterMemoryModules.IS_IN_WATER, MemoryModuleState.VALUE_ABSENT)
                )
        );
    }
    ...
    private static void addSwimActivities(Brain<FrogEntity> brain) {
        brain.setTaskList(
                ...
                ImmutableSet.of(
                        Pair.of(MemoryModuleType.LONG_JUMP_MID_JUMP, MemoryModuleState.VALUE_ABSENT),
                        Pair.of(RegisterMemoryModules.IS_IN_WATER, MemoryModuleState.VALUE_PRESENT)
                )
        );
    }
    ...
    private static void addLaySpawnActivities(Brain<FrogEntity> brain) {
        brain.setTaskList(
                ...
                ImmutableList.of(
                        Pair.of(0, new TimeLimitedTask<>(new FollowMobTask(EntityType.PLAYER, 6.0F), UniformIntProvider.create(30, 60))),
                        Pair.of(1, new net.frozenblock.wildmod.entity.ai.task.UpdateAttackTargetTask<>(FrogBrain::isNotBreeding, frog -> frog.getBrain().getOptionalMemory(MemoryModuleType.NEAREST_ATTACKABLE))),
                        Pair.of(2, new WalkTowardsWaterTask(8, 1.0F)),
                        Pair.of(3, new LayFrogSpawnTask(RegisterBlocks.FROGSPAWN, RegisterMemoryModules.IS_PREGNANT)),
                        Pair.of(
                                4,
                                new RandomTask<>(
                                        ImmutableList.of(
                ...
                ImmutableSet.of(
                        Pair.of(MemoryModuleType.LONG_JUMP_MID_JUMP, MemoryModuleState.VALUE_ABSENT),
                        Pair.of(RegisterMemoryModules.IS_PREGNANT, MemoryModuleState.VALUE_PRESENT)
                )
        );
    }
    ...
    private static void addLongJumpActivities(Brain<FrogEntity> brain) {
        brain.setTaskList(
                Activity.LONG_JUMP,
                ImmutableList.of(
                        Pair.of(0, new LeapingChargeTask(longJumpCooldownRange, RegisterSounds.ENTITY_FROG_STEP)),
                        Pair.of(
                                1,
                                new BiasedLongJumpTask<>(
                                        ...
                                        4,
                                        1.5F,
                                        frog -> RegisterSounds.ENTITY_FROG_LONG_JUMP,
                                        RegisterTags.FROG_PREFER_JUMP_TO,
                                        0.5F,
                                        state -> state.isOf(Blocks.LILY_PAD)
                                )
                        )
                ),
                ImmutableSet.of(
    ...
    private static void addTongueActivities(Brain<FrogEntity> brain) {
        brain.setTaskList(
                WildMod.TONGUE,
                0,
                ImmutableList.of(new net.frozenblock.wildmod.entity.ai.task.ForgetAttackTargetTask<>(), new FrogEatEntityTask(RegisterSounds.ENTITY_FROG_TOUNGE, RegisterSounds.ENTITY_FROG_EAT)),
