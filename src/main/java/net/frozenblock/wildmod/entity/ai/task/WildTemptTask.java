...
public class WildTemptTask extends Task<PathAwareEntity> {
    ...
    public WildTemptTask(Function<LivingEntity, Float> speed) {
        super(Util.make(() -> {
            ...
            builder.put(RegisterMemoryModules.IS_PANICKING, MemoryModuleState.VALUE_ABSENT);
    ...
    protected boolean shouldKeepRunning(ServerWorld serverWorld, PathAwareEntity pathAwareEntity, long l) {
        return this.getTemptingPlayer(pathAwareEntity).isPresent()
                ...
                && !pathAwareEntity.getBrain().hasMemoryModule(RegisterMemoryModules.IS_PANICKING);
    }
