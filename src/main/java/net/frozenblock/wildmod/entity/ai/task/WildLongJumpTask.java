...
public class WildLongJumpTask<E extends MobEntity> extends Task<E> {
    ...
    protected List<WildLongJumpTask.Target> targets = Lists.newArrayList();
    ...
    protected void run(ServerWorld serverWorld, E mobEntity, long l) {
        ...
        this.targets = BlockPos.stream(
                ...
                .map(blockPos2 -> new WildLongJumpTask.Target(blockPos2.toImmutable(), MathHelper.ceil(blockPos.getSquaredDistance(blockPos2))))
    ...
    protected Optional<WildLongJumpTask.Target> getTarget(ServerWorld world) {
        Optional<WildLongJumpTask.Target> optional = Weighting.getRandom(world.random, this.targets);
