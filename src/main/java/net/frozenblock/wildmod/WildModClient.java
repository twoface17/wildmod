...
import net.frozenblock.wildmod.entity.render.TexturedModelData;
...
import net.frozenblock.wildmod.render.entity.WildEntityRendererRegistry;
...
public class WildModClient implements ClientModInitializer {
    ...
    public static final net.frozenblock.wildmod.entity.render.EntityModelLayer WARDEN = new net.frozenblock.wildmod.entity.render.EntityModelLayer(new Identifier(WildMod.MOD_ID, "warden"), "main");
    ...
    public void onInitializeClient() {
        ImmutableMap.Builder<net.frozenblock.wildmod.entity.render.EntityModelLayer, TexturedModelData> builder = ImmutableMap.builder();
...
//            registry.register(new Identifier(WildMod.MOD_ID, "particle/sculk_rf_0"));
        ...
        WildEntityRendererRegistry.register(RegisterEntities.WARDEN, WardenEntityRenderer::new);
        net.frozenblock.wildmod.entity.render.EntityModelLayerRegistry.registerModelLayer(WARDEN, WardenEntityModel::getTexturedModelData);
        ...
        WildEntityRendererRegistry.register(RegisterEntities.MANGROVE_BOAT, context -> new MangroveBoatEntityRenderer(context, false));
        net.frozenblock.wildmod.entity.render.TexturedModelData texturedModelData19 = MangroveBoatEntityModel.getTexturedModelData(false);
        net.frozenblock.wildmod.entity.render.TexturedModelData texturedModelData20 = MangroveBoatEntityModel.getTexturedModelData(true);

        for(BoatEntity.Type type : BoatEntity.Type.values()) {
            builder.put(net.frozenblock.wildmod.entity.render.EntityModelLayers.createBoat(type), texturedModelData19);
