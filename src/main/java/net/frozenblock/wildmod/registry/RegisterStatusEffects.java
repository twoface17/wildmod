...
public class RegisterStatusEffects {
    public static final StatusEffect DARKNESS = new StatusEffect(StatusEffectCategory.HARMFUL, 2696993).setFactorCalculationDataSupplier(() -> new StatusEffectInstance.FactorCalculationData(22));
