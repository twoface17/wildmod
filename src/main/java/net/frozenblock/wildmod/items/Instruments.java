...
public interface Instruments {
    ...
    private static RegistryKey<Instrument> of(String id) {
        return RegistryKey.of(WildRegistry.INSTRUMENT_KEY, new Identifier(WildMod.MOD_ID, id));
    }
    ...
    static Instrument registerAndGetDefault(Registry<Instrument> registry) {
        ...
        Registry.register(registry, YEARN_GOAT_HORN, new Instrument(RegisterSounds.GOAT_HORN_SOUNDS.get(6), 140, 256.0F));
        return Registry.register(registry, DREAM_GOAT_HORN, new Instrument(RegisterSounds.GOAT_HORN_SOUNDS.get(7), 140, 256.0F));
    }
}
