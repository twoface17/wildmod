package net.frozenblock.wildmod.data;
...
public class DataCache {
    ...
    public boolean isVersionDifferent(DataProvider dataProvider) {
        DataCache.CachedData cachedData = this.cachedDatas.get(dataProvider);
    ...
    public DataWriter getOrCreateWriter(DataProvider dataProvider) {
        return this.dataWriters.computeIfAbsent(dataProvider, provider -> {
            DataCache.CachedData cachedData = this.cachedDatas.get(provider);
            if (cachedData == null) {
    ...
    public void write() throws IOException {
        ...
        LOGGER.info(
                ...
                new Object[]{mutableInt2, this.totalSize, set.size(), mutableInt3, mutableInt}
        );
    }
