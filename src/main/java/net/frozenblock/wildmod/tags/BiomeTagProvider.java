...
public class BiomeTagProvider extends AbstractTagProvider<Biome> {
    public BiomeTagProvider(final DataGenerator dataGenerator) {
    ...
    protected void configure() {
        ...
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.IS_SAVANNA).add(BiomeKeys.SAVANNA).add(BiomeKeys.SAVANNA_PLATEAU).add(BiomeKeys.WINDSWEPT_SAVANNA);
        final ObjectBuilder<Biome> objectBuilder = this.getOrCreateTagBuilder(BiomeTags.IS_NETHER);
        final Stream<RegistryKey<Biome>> stream = MultiNoiseBiomeSource.Preset.NETHER.getBiomeSource(BuiltinRegistries.BIOME).getBiomes().stream().flatMap(entry -> entry.getKey().stream());
        Objects.requireNonNull(objectBuilder);
        stream.forEach(objectBuilder::add);
        final ObjectBuilder<Biome> objectBuilder2 = this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.IS_OVERWORLD);
        final Stream<RegistryKey<Biome>> stream2 = MultiNoiseBiomeSource.Preset.OVERWORLD.getBiomeSource(BuiltinRegistries.BIOME).getBiomes().stream().flatMap(entry -> entry.getKey().stream());
        Objects.requireNonNull(objectBuilder2);
        stream2.forEach(objectBuilder::add);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.IS_END).add(BiomeKeys.THE_END).add(BiomeKeys.END_HIGHLANDS).add(BiomeKeys.END_MIDLANDS).add(BiomeKeys.SMALL_END_ISLANDS).add(BiomeKeys.END_BARRENS);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.SPAWNS_COLD_VARIANT_FROGS).add(BiomeKeys.SNOWY_PLAINS).add(BiomeKeys.ICE_SPIKES).add(BiomeKeys.FROZEN_PEAKS).add(BiomeKeys.JAGGED_PEAKS).add(BiomeKeys.SNOWY_SLOPES).add(BiomeKeys.FROZEN_OCEAN).add(BiomeKeys.DEEP_FROZEN_OCEAN).add(BiomeKeys.GROVE).add(RegisterWorldgen.DEEP_DARK).add(BiomeKeys.FROZEN_RIVER).add(BiomeKeys.SNOWY_TAIGA).add(BiomeKeys.SNOWY_BEACH).addTag(net.frozenblock.wildmod.tags.BiomeTags.IS_END);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.SPAWNS_WARM_VARIANT_FROGS).add(BiomeKeys.DESERT).add(BiomeKeys.WARM_OCEAN).addTag(net.minecraft.tag.BiomeTags.IS_JUNGLE).addTag(net.frozenblock.wildmod.tags.BiomeTags.IS_SAVANNA).addTag(net.minecraft.tag.BiomeTags.IS_NETHER).addTag(BiomeTags.IS_BADLANDS).add(RegisterWorldgen.MANGROVE_SWAMP);
        ...
        this.getOrCreateTagBuilder(BiomeTags.MINESHAFT_HAS_STRUCTURE).addTag(BiomeTags.IS_OCEAN).addTag(BiomeTags.IS_RIVER).addTag(BiomeTags.IS_BEACH).addTag(BiomeTags.IS_MOUNTAIN).addTag(BiomeTags.IS_HILL).addTag(BiomeTags.IS_TAIGA).addTag(BiomeTags.IS_JUNGLE).addTag(BiomeTags.IS_FOREST).add(BiomeKeys.STONY_SHORE).add(BiomeKeys.MUSHROOM_FIELDS).add(BiomeKeys.ICE_SPIKES).add(BiomeKeys.WINDSWEPT_SAVANNA).add(BiomeKeys.DESERT).add(BiomeKeys.SAVANNA).add(BiomeKeys.SNOWY_PLAINS).add(BiomeKeys.PLAINS).add(BiomeKeys.SUNFLOWER_PLAINS).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP).add(BiomeKeys.SAVANNA_PLATEAU).add(BiomeKeys.DRIPSTONE_CAVES).add(BiomeKeys.LUSH_CAVES);
        ...
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.REQUIRED_OCEAN_MONUMENT_SURROUNDING).addTag(BiomeTags.IS_OCEAN).addTag(BiomeTags.IS_RIVER);
        ...
        this.getOrCreateTagBuilder(BiomeTags.RUINED_PORTAL_SWAMP_HAS_STRUCTURE).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP);
        ...
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.ANCIENT_CITY_HAS_STRUCTURE).add(RegisterWorldgen.DEEP_DARK);
        ...
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.PRODUCES_CORALS_FROM_BONEMEAL).add(BiomeKeys.WARM_OCEAN);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.PLAYS_UNDERWATER_MUSIC).addTag(BiomeTags.IS_OCEAN).addTag(BiomeTags.IS_RIVER);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.HAS_CLOSER_WATER_FOG).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.WATER_ON_MAP_OUTLINES).addTag(BiomeTags.IS_OCEAN).addTag(BiomeTags.IS_RIVER).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.WITHOUT_ZOMBIE_SIEGES).add(BiomeKeys.MUSHROOM_FIELDS);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.WITHOUT_PATROL_SPAWNS).add(BiomeKeys.MUSHROOM_FIELDS);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.WITHOUT_WANDERING_TRADER_SPAWNS).add(BiomeKeys.THE_VOID);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.SPAWNS_COLD_VARIANT_FROGS).add(BiomeKeys.SNOWY_PLAINS).add(BiomeKeys.ICE_SPIKES).add(BiomeKeys.FROZEN_PEAKS).add(BiomeKeys.JAGGED_PEAKS).add(BiomeKeys.SNOWY_SLOPES).add(BiomeKeys.FROZEN_OCEAN).add(BiomeKeys.DEEP_FROZEN_OCEAN).add(BiomeKeys.GROVE).add(RegisterWorldgen.DEEP_DARK).add(BiomeKeys.FROZEN_RIVER).add(BiomeKeys.SNOWY_TAIGA).add(BiomeKeys.SNOWY_BEACH).addTag(net.frozenblock.wildmod.tags.BiomeTags.IS_END);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.SPAWNS_WARM_VARIANT_FROGS).add(BiomeKeys.DESERT).add(BiomeKeys.WARM_OCEAN).addTag(BiomeTags.IS_JUNGLE).addTag(net.frozenblock.wildmod.tags.BiomeTags.IS_SAVANNA).addTag(BiomeTags.IS_NETHER).addTag(BiomeTags.IS_BADLANDS).add(RegisterWorldgen.MANGROVE_SWAMP);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.ONLY_ALLOWS_SNOW_AND_GOLD_RABBITS).add(BiomeKeys.DESERT);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.REDUCE_WATER_AMBIENT_SPAWNS).addTag(BiomeTags.IS_RIVER);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.ALLOWS_TROPICAL_FISH_SPAWNS_AT_ANY_HEIGHT).add(BiomeKeys.LUSH_CAVES);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS).add(BiomeKeys.FROZEN_OCEAN).add(BiomeKeys.DEEP_FROZEN_OCEAN);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.MORE_FREQUENT_DROWNED_SPAWNS).addTag(BiomeTags.IS_RIVER);
        this.getOrCreateTagBuilder(net.frozenblock.wildmod.tags.BiomeTags.ALLOWS_SURFACE_SLIME_SPAWNS).add(BiomeKeys.SWAMP).add(RegisterWorldgen.MANGROVE_SWAMP);
