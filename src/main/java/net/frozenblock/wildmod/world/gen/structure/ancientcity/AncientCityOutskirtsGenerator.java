    ...
    static {
        StructurePools.register(
                new StructurePool(
                        ...
                        ImmutableList.of(
                                Pair.of(WildStructurePoolElement.ofEmpty(), 7),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/barracks", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION), 4
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/chamber_1", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        4
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/chamber_2", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        4
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/chamber_3", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        4
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/sauna_1", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION), 4
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/small_statue", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        4
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/large_ruin_1", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        1
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/tall_ruin_1", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        1
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/tall_ruin_2", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        1
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/tall_ruin_3", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        2
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/structures/tall_ruin_4", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        2
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofList(
                                                ImmutableList.of(
                                                        WildStructurePoolElement.ofProcessedSingle(
                                ...
                                Pair.of(WildStructurePoolElement.ofList(ImmutableList.of(WildStructurePoolElement.ofSingle("ancient_city/structures/ice_box_1"))), 1)
                        ),
        ...
        StructurePools.register(
                new StructurePool(
                        ...
                        new Identifier("empty"),
                        ImmutableList.of(
                                Pair.of(StructurePoolElement.ofFeature(WildPlacedFeatures.SCULK_PATCH_ANCIENT_CITY), 6), Pair.of(WildStructurePoolElement.ofEmpty(), 1)
                        ),
                        StructurePool.Projection.RIGID
                )
        );
        ...
        StructurePools.register(
                new StructurePool(
                        ...
                        ImmutableList.of(
                                ...
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/city_center/walls/left", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        1
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/city_center/walls/right", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        1
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle("ancient_city/city_center/walls/top", RegisterWorldgen.ANCIENT_CITY_GENERIC_DEGRADATION),
                                        1
                                ),
                                Pair.of(
                                        WildStructurePoolElement.ofProcessedSingle(
