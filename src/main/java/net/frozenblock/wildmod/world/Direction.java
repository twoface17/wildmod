...
package net.frozenblock.wildmod.world;
...
public enum Direction implements StringIdentifiable {
    ...
    public static Collection<Direction> shuffle(WildAbstractRandom random) {
        return net.frozenblock.wildmod.registry.Util.copyShuffled(values(), random);
    }
    ...
    public static Direction random(WildAbstractRandom random) {
        return (Direction) net.frozenblock.wildmod.registry.Util.getRandom(ALL, random);
    }
    ...
    public static enum Axis implements StringIdentifiable, Predicate<Direction> {
        ...
        public static final Codec<Direction.Axis> CODEC = StringIdentifiable.createCodec(Direction.Axis::values);
        private final String name;
        ...
        public static Direction.Axis pickRandomAxis(WildAbstractRandom random) {
            return (Direction.Axis) net.frozenblock.wildmod.registry.Util.getRandom(VALUES, random);
        }
    ...
    public static enum Type implements Iterable<Direction>, Predicate<Direction> {
        ...
        public Direction random(WildAbstractRandom random) {
            return (Direction) net.frozenblock.wildmod.registry.Util.getRandom(this.facingArray, random);
        }

        public Direction.Axis randomAxis(WildAbstractRandom random) {
            return (Direction.Axis) net.frozenblock.wildmod.registry.Util.getRandom(this.axisArray, random);
        }
        ...
        public List<Direction> getShuffled(WildAbstractRandom random) {
