    ...
    public static class EntityContent {
        ...
        public List<Text> asTooltip() {
            if (this.tooltip == null) {
                ...
                this.tooltip.add(Text.translatable("gui.entity_tooltip.type", new Object[]{this.entityType.getName()}));
        ...
        public boolean equals(Object o) {
            if (this == o) {
                ...
                return this.entityType.equals(entityContent.entityType)
                        && this.uuid.equals(entityContent.uuid)
                        && Objects.equals(this.name, entityContent.name);
            } else {
                return false;
            }
        }
    ...
    public static class ItemStackContent {
        ...
        private static HoverEvent.ItemStackContent parse(JsonElement json) {
            if (json.isJsonPrimitive()) {
                return new HoverEvent.ItemStackContent((Item)Registry.ITEM.get(new Identifier(json.getAsString())), 1, null);
            } else {
